define([
	...
	var _Splitter = declare("dijit.layout._Splitter", [_Widget, _TemplatedMixin ], {
		...
		_computeMaxSize: function(){
			...
			console.log(this.child.maxSize);
			console.log((childSize+spaceAvailable));
		...
		_startDrag: function(e){
			...
			var factor = this._factor,
				...
				min = Math.max(this.child.minSize, domGeometry.getPadBorderExtents(this.child.domNode, childCS)[dim]),
				region = this.region,
